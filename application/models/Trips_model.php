...
class Trips_model extends CI_Model
{
	...
	public function getall_trips($trackingcode = false, $user_type = null, $user_id = null)
	{
		$this->db
			->select('
			trips.*,
		...
		if ($user_type === 'vendor') {
			// Filter trips for vehicles belonging to this vendor
			$this->db->where('vehicles.v_vendor_name', $user_id);
		} elseif ($user_type === 'driver') {
			// Filter trips where this driver was assigned
