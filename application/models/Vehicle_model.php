...
class vehicle_model extends CI_Model
{
	...
	public function add_vehicle($data)
	{
		...
		unset($data['minitruckfields']);
		unset($data['openbodytruckfields']);
		unset($data['closedcontainerfields']);
		unset($data['trailerfields']);
		unset($data['tankerfields']);
		unset($data['tipperfields']);
		unset($data['carfields']);
		unset($data['vanfields']);
		unset($data['minibusfields']);
	...
	public function edit_vehicle()
	{
		...
		unset($_POST['minitruckfields']);
		unset($_POST['openbodytruckfields']);
		unset($_POST['closedcontainerfields']);
		unset($_POST['trailerfields']);
		unset($_POST['tankerfields']);
		unset($_POST['tipperfields']);
		unset($_POST['carfields']);
		unset($_POST['vanfields']);
		unset($_POST['minibusfields']);
		unset($_POST['otherfields']);
		if (isset($_POST['v_ownership']) && $_POST['v_ownership'] == 'owned') {
			$_POST['v_vendor_name'] = '';
			$_POST['v_lease_start_date'] = '';
			$_POST['v_lease_end_date'] = '';
			$_POST['v_lease_payment'] = '';
		}
