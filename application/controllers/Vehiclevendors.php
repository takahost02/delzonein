...
class Vehiclevendors extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($user_type === 'admin') {
            ...
            // Step 1: Join trips and vehicles to get vendor names where the driver was involved
